...
using XF.SignaturePad.Droid;

[assembly: ExportRenderer(typeof(XF.SignaturePad.SignaturePadView), typeof(SignaturePadViewRenderer))]
namespace XF.SignaturePad.Droid
{
    /// <summary>
